...
def proof(n):
    return n + proof(n - 1) if n > 0 else 0


print("Программа проверяет, что для множества натуральных чисел выполняется равенство: 1+2+...+n = n(n+1)/2")
n = float(input("Введите n = "))
print(proof(n) == n * (n + 1) / 2)
